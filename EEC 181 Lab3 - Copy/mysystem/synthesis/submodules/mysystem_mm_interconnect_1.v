...
module mysystem_mm_interconnect_1 (
		...
		output wire [1:0]  doneSignal_s1_address,                                               //                                                 doneSignal_s1.address
		output wire        doneSignal_s1_write,                                                 //                                                              .write
		input  wire [31:0] doneSignal_s1_readdata,                                              //                                                              .readdata
		output wire [31:0] doneSignal_s1_writedata,                                             //                                                              .writedata
		output wire        doneSignal_s1_chipselect,                                            //                                                              .chipselect
		...
		output wire [1:0]  StartSignal_s1_address,                                              //                                                StartSignal_s1.address
		output wire        StartSignal_s1_write,                                                //                                                              .write
		input  wire [31:0] StartSignal_s1_readdata,                                             //                                                              .readdata
		output wire [31:0] StartSignal_s1_writedata,                                            //                                                              .writedata
		output wire        StartSignal_s1_chipselect,                                           //                                                              .chipselect
	...
	wire   [31:0] startsignal_s1_agent_m0_readdata;                                            // StartSignal_s1_translator:uav_readdata -> StartSignal_s1_agent:m0_readdata
	wire          startsignal_s1_agent_m0_waitrequest;                                         // StartSignal_s1_translator:uav_waitrequest -> StartSignal_s1_agent:m0_waitrequest
	wire          startsignal_s1_agent_m0_debugaccess;                                         // StartSignal_s1_agent:m0_debugaccess -> StartSignal_s1_translator:uav_debugaccess
	wire   [20:0] startsignal_s1_agent_m0_address;                                             // StartSignal_s1_agent:m0_address -> StartSignal_s1_translator:uav_address
	wire    [3:0] startsignal_s1_agent_m0_byteenable;                                          // StartSignal_s1_agent:m0_byteenable -> StartSignal_s1_translator:uav_byteenable
	wire          startsignal_s1_agent_m0_read;                                                // StartSignal_s1_agent:m0_read -> StartSignal_s1_translator:uav_read
	wire          startsignal_s1_agent_m0_readdatavalid;                                       // StartSignal_s1_translator:uav_readdatavalid -> StartSignal_s1_agent:m0_readdatavalid
	wire          startsignal_s1_agent_m0_lock;                                                // StartSignal_s1_agent:m0_lock -> StartSignal_s1_translator:uav_lock
	wire   [31:0] startsignal_s1_agent_m0_writedata;                                           // StartSignal_s1_agent:m0_writedata -> StartSignal_s1_translator:uav_writedata
	wire          startsignal_s1_agent_m0_write;                                               // StartSignal_s1_agent:m0_write -> StartSignal_s1_translator:uav_write
	wire    [2:0] startsignal_s1_agent_m0_burstcount;                                          // StartSignal_s1_agent:m0_burstcount -> StartSignal_s1_translator:uav_burstcount
	wire          startsignal_s1_agent_rf_source_valid;                                        // StartSignal_s1_agent:rf_source_valid -> StartSignal_s1_agent_rsp_fifo:in_valid
	wire  [116:0] startsignal_s1_agent_rf_source_data;                                         // StartSignal_s1_agent:rf_source_data -> StartSignal_s1_agent_rsp_fifo:in_data
	wire          startsignal_s1_agent_rf_source_ready;                                        // StartSignal_s1_agent_rsp_fifo:in_ready -> StartSignal_s1_agent:rf_source_ready
	wire          startsignal_s1_agent_rf_source_startofpacket;                                // StartSignal_s1_agent:rf_source_startofpacket -> StartSignal_s1_agent_rsp_fifo:in_startofpacket
	wire          startsignal_s1_agent_rf_source_endofpacket;                                  // StartSignal_s1_agent:rf_source_endofpacket -> StartSignal_s1_agent_rsp_fifo:in_endofpacket
	wire          startsignal_s1_agent_rsp_fifo_out_valid;                                     // StartSignal_s1_agent_rsp_fifo:out_valid -> StartSignal_s1_agent:rf_sink_valid
	wire  [116:0] startsignal_s1_agent_rsp_fifo_out_data;                                      // StartSignal_s1_agent_rsp_fifo:out_data -> StartSignal_s1_agent:rf_sink_data
	wire          startsignal_s1_agent_rsp_fifo_out_ready;                                     // StartSignal_s1_agent:rf_sink_ready -> StartSignal_s1_agent_rsp_fifo:out_ready
	wire          startsignal_s1_agent_rsp_fifo_out_startofpacket;                             // StartSignal_s1_agent_rsp_fifo:out_startofpacket -> StartSignal_s1_agent:rf_sink_startofpacket
	wire          startsignal_s1_agent_rsp_fifo_out_endofpacket;                               // StartSignal_s1_agent_rsp_fifo:out_endofpacket -> StartSignal_s1_agent:rf_sink_endofpacket
	wire          startsignal_s1_agent_rdata_fifo_src_valid;                                   // StartSignal_s1_agent:rdata_fifo_src_valid -> StartSignal_s1_agent_rdata_fifo:in_valid
	wire   [33:0] startsignal_s1_agent_rdata_fifo_src_data;                                    // StartSignal_s1_agent:rdata_fifo_src_data -> StartSignal_s1_agent_rdata_fifo:in_data
	wire          startsignal_s1_agent_rdata_fifo_src_ready;                                   // StartSignal_s1_agent_rdata_fifo:in_ready -> StartSignal_s1_agent:rdata_fifo_src_ready
	wire   [31:0] donesignal_s1_agent_m0_readdata;                                             // doneSignal_s1_translator:uav_readdata -> doneSignal_s1_agent:m0_readdata
	wire          donesignal_s1_agent_m0_waitrequest;                                          // doneSignal_s1_translator:uav_waitrequest -> doneSignal_s1_agent:m0_waitrequest
	wire          donesignal_s1_agent_m0_debugaccess;                                          // doneSignal_s1_agent:m0_debugaccess -> doneSignal_s1_translator:uav_debugaccess
	wire   [20:0] donesignal_s1_agent_m0_address;                                              // doneSignal_s1_agent:m0_address -> doneSignal_s1_translator:uav_address
	wire    [3:0] donesignal_s1_agent_m0_byteenable;                                           // doneSignal_s1_agent:m0_byteenable -> doneSignal_s1_translator:uav_byteenable
	wire          donesignal_s1_agent_m0_read;                                                 // doneSignal_s1_agent:m0_read -> doneSignal_s1_translator:uav_read
	wire          donesignal_s1_agent_m0_readdatavalid;                                        // doneSignal_s1_translator:uav_readdatavalid -> doneSignal_s1_agent:m0_readdatavalid
	wire          donesignal_s1_agent_m0_lock;                                                 // doneSignal_s1_agent:m0_lock -> doneSignal_s1_translator:uav_lock
	wire   [31:0] donesignal_s1_agent_m0_writedata;                                            // doneSignal_s1_agent:m0_writedata -> doneSignal_s1_translator:uav_writedata
	wire          donesignal_s1_agent_m0_write;                                                // doneSignal_s1_agent:m0_write -> doneSignal_s1_translator:uav_write
	wire    [2:0] donesignal_s1_agent_m0_burstcount;                                           // doneSignal_s1_agent:m0_burstcount -> doneSignal_s1_translator:uav_burstcount
	wire          donesignal_s1_agent_rf_source_valid;                                         // doneSignal_s1_agent:rf_source_valid -> doneSignal_s1_agent_rsp_fifo:in_valid
	wire  [116:0] donesignal_s1_agent_rf_source_data;                                          // doneSignal_s1_agent:rf_source_data -> doneSignal_s1_agent_rsp_fifo:in_data
	wire          donesignal_s1_agent_rf_source_ready;                                         // doneSignal_s1_agent_rsp_fifo:in_ready -> doneSignal_s1_agent:rf_source_ready
	wire          donesignal_s1_agent_rf_source_startofpacket;                                 // doneSignal_s1_agent:rf_source_startofpacket -> doneSignal_s1_agent_rsp_fifo:in_startofpacket
	wire          donesignal_s1_agent_rf_source_endofpacket;                                   // doneSignal_s1_agent:rf_source_endofpacket -> doneSignal_s1_agent_rsp_fifo:in_endofpacket
	wire          donesignal_s1_agent_rsp_fifo_out_valid;                                      // doneSignal_s1_agent_rsp_fifo:out_valid -> doneSignal_s1_agent:rf_sink_valid
	wire  [116:0] donesignal_s1_agent_rsp_fifo_out_data;                                       // doneSignal_s1_agent_rsp_fifo:out_data -> doneSignal_s1_agent:rf_sink_data
	wire          donesignal_s1_agent_rsp_fifo_out_ready;                                      // doneSignal_s1_agent:rf_sink_ready -> doneSignal_s1_agent_rsp_fifo:out_ready
	wire          donesignal_s1_agent_rsp_fifo_out_startofpacket;                              // doneSignal_s1_agent_rsp_fifo:out_startofpacket -> doneSignal_s1_agent:rf_sink_startofpacket
	wire          donesignal_s1_agent_rsp_fifo_out_endofpacket;                                // doneSignal_s1_agent_rsp_fifo:out_endofpacket -> doneSignal_s1_agent:rf_sink_endofpacket
	wire          donesignal_s1_agent_rdata_fifo_src_valid;                                    // doneSignal_s1_agent:rdata_fifo_src_valid -> doneSignal_s1_agent_rdata_fifo:in_valid
	wire   [33:0] donesignal_s1_agent_rdata_fifo_src_data;                                     // doneSignal_s1_agent:rdata_fifo_src_data -> doneSignal_s1_agent_rdata_fifo:in_data
	wire          donesignal_s1_agent_rdata_fifo_src_ready;                                    // doneSignal_s1_agent_rdata_fifo:in_ready -> doneSignal_s1_agent:rdata_fifo_src_ready
	...
	wire  [115:0] pushbuttons_s1_agent_rp_data;                                                // pushbuttons_s1_agent:rp_data -> router_004:sink_data
	...
	wire          startsignal_s1_agent_rp_valid;                                               // StartSignal_s1_agent:rp_valid -> router_005:sink_valid
	wire  [115:0] startsignal_s1_agent_rp_data;                                                // StartSignal_s1_agent:rp_data -> router_005:sink_data
	wire          startsignal_s1_agent_rp_ready;                                               // router_005:sink_ready -> StartSignal_s1_agent:rp_ready
	wire          startsignal_s1_agent_rp_startofpacket;                                       // StartSignal_s1_agent:rp_startofpacket -> router_005:sink_startofpacket
	wire          startsignal_s1_agent_rp_endofpacket;                                         // StartSignal_s1_agent:rp_endofpacket -> router_005:sink_endofpacket
	...
	wire          donesignal_s1_agent_rp_valid;                                                // doneSignal_s1_agent:rp_valid -> router_006:sink_valid
	wire  [115:0] donesignal_s1_agent_rp_data;                                                 // doneSignal_s1_agent:rp_data -> router_006:sink_data
	wire          donesignal_s1_agent_rp_ready;                                                // router_006:sink_ready -> doneSignal_s1_agent:rp_ready
	wire          donesignal_s1_agent_rp_startofpacket;                                        // doneSignal_s1_agent:rp_startofpacket -> router_006:sink_startofpacket
	wire          donesignal_s1_agent_rp_endofpacket;                                          // doneSignal_s1_agent:rp_endofpacket -> router_006:sink_endofpacket
	...
	wire    [4:0] cmd_mux_src_channel;                                                         // cmd_mux:src_channel -> system_console_avalon_jtag_slave_burst_adapter:sink0_channel
	...
	wire    [4:0] system_console_avalon_jtag_slave_burst_adapter_source0_channel;              // system_console_avalon_jtag_slave_burst_adapter:source0_channel -> system_console_avalon_jtag_slave_agent:cp_channel
	...
	wire    [4:0] cmd_mux_001_src_channel;                                                     // cmd_mux_001:src_channel -> reg32_avalon_interface_0_avalon_slave_0_burst_adapter:sink0_channel
	...
	wire    [4:0] reg32_avalon_interface_0_avalon_slave_0_burst_adapter_source0_channel;       // reg32_avalon_interface_0_avalon_slave_0_burst_adapter:source0_channel -> reg32_avalon_interface_0_avalon_slave_0_agent:cp_channel
	...
	wire  [115:0] cmd_mux_002_src_data;                                                        // cmd_mux_002:src_data -> pushbuttons_s1_burst_adapter:sink0_data
	wire          cmd_mux_002_src_ready;                                                       // pushbuttons_s1_burst_adapter:sink0_ready -> cmd_mux_002:src_ready
	wire    [4:0] cmd_mux_002_src_channel;                                                     // cmd_mux_002:src_channel -> pushbuttons_s1_burst_adapter:sink0_channel
	...
	wire          cmd_mux_003_src_valid;                                                       // cmd_mux_003:src_valid -> StartSignal_s1_burst_adapter:sink0_valid
	wire  [115:0] cmd_mux_003_src_data;                                                        // cmd_mux_003:src_data -> StartSignal_s1_burst_adapter:sink0_data
	wire          cmd_mux_003_src_ready;                                                       // StartSignal_s1_burst_adapter:sink0_ready -> cmd_mux_003:src_ready
	wire    [4:0] cmd_mux_003_src_channel;                                                     // cmd_mux_003:src_channel -> StartSignal_s1_burst_adapter:sink0_channel
	wire          cmd_mux_003_src_startofpacket;                                               // cmd_mux_003:src_startofpacket -> StartSignal_s1_burst_adapter:sink0_startofpacket
	wire          cmd_mux_003_src_endofpacket;                                                 // cmd_mux_003:src_endofpacket -> StartSignal_s1_burst_adapter:sink0_endofpacket
	wire          startsignal_s1_burst_adapter_source0_valid;                                  // StartSignal_s1_burst_adapter:source0_valid -> StartSignal_s1_agent:cp_valid
	wire  [115:0] startsignal_s1_burst_adapter_source0_data;                                   // StartSignal_s1_burst_adapter:source0_data -> StartSignal_s1_agent:cp_data
	wire          startsignal_s1_burst_adapter_source0_ready;                                  // StartSignal_s1_agent:cp_ready -> StartSignal_s1_burst_adapter:source0_ready
	wire    [4:0] startsignal_s1_burst_adapter_source0_channel;                                // StartSignal_s1_burst_adapter:source0_channel -> StartSignal_s1_agent:cp_channel
	wire          startsignal_s1_burst_adapter_source0_startofpacket;                          // StartSignal_s1_burst_adapter:source0_startofpacket -> StartSignal_s1_agent:cp_startofpacket
	wire          startsignal_s1_burst_adapter_source0_endofpacket;                            // StartSignal_s1_burst_adapter:source0_endofpacket -> StartSignal_s1_agent:cp_endofpacket
	wire          cmd_mux_004_src_valid;                                                       // cmd_mux_004:src_valid -> doneSignal_s1_burst_adapter:sink0_valid
	wire  [115:0] cmd_mux_004_src_data;                                                        // cmd_mux_004:src_data -> doneSignal_s1_burst_adapter:sink0_data
	wire          cmd_mux_004_src_ready;                                                       // doneSignal_s1_burst_adapter:sink0_ready -> cmd_mux_004:src_ready
	wire    [4:0] cmd_mux_004_src_channel;                                                     // cmd_mux_004:src_channel -> doneSignal_s1_burst_adapter:sink0_channel
	wire          cmd_mux_004_src_startofpacket;                                               // cmd_mux_004:src_startofpacket -> doneSignal_s1_burst_adapter:sink0_startofpacket
	wire          cmd_mux_004_src_endofpacket;                                                 // cmd_mux_004:src_endofpacket -> doneSignal_s1_burst_adapter:sink0_endofpacket
	wire          donesignal_s1_burst_adapter_source0_valid;                                   // doneSignal_s1_burst_adapter:source0_valid -> doneSignal_s1_agent:cp_valid
	wire  [115:0] donesignal_s1_burst_adapter_source0_data;                                    // doneSignal_s1_burst_adapter:source0_data -> doneSignal_s1_agent:cp_data
	wire          donesignal_s1_burst_adapter_source0_ready;                                   // doneSignal_s1_agent:cp_ready -> doneSignal_s1_burst_adapter:source0_ready
	wire    [4:0] donesignal_s1_burst_adapter_source0_channel;                                 // doneSignal_s1_burst_adapter:source0_channel -> doneSignal_s1_agent:cp_channel
	wire          donesignal_s1_burst_adapter_source0_startofpacket;                           // doneSignal_s1_burst_adapter:source0_startofpacket -> doneSignal_s1_agent:cp_startofpacket
	wire          donesignal_s1_burst_adapter_source0_endofpacket;                             // doneSignal_s1_burst_adapter:source0_endofpacket -> doneSignal_s1_agent:cp_endofpacket
	...
	wire          startsignal_s1_agent_rdata_fifo_out_valid;                                   // StartSignal_s1_agent_rdata_fifo:out_valid -> avalon_st_adapter_003:in_0_valid
	wire   [33:0] startsignal_s1_agent_rdata_fifo_out_data;                                    // StartSignal_s1_agent_rdata_fifo:out_data -> avalon_st_adapter_003:in_0_data
	wire          startsignal_s1_agent_rdata_fifo_out_ready;                                   // avalon_st_adapter_003:in_0_ready -> StartSignal_s1_agent_rdata_fifo:out_ready
	wire          avalon_st_adapter_003_out_0_valid;                                           // avalon_st_adapter_003:out_0_valid -> StartSignal_s1_agent:rdata_fifo_sink_valid
	wire   [33:0] avalon_st_adapter_003_out_0_data;                                            // avalon_st_adapter_003:out_0_data -> StartSignal_s1_agent:rdata_fifo_sink_data
	wire          avalon_st_adapter_003_out_0_ready;                                           // StartSignal_s1_agent:rdata_fifo_sink_ready -> avalon_st_adapter_003:out_0_ready
	wire    [0:0] avalon_st_adapter_003_out_0_error;                                           // avalon_st_adapter_003:out_0_error -> StartSignal_s1_agent:rdata_fifo_sink_error
	wire          donesignal_s1_agent_rdata_fifo_out_valid;                                    // doneSignal_s1_agent_rdata_fifo:out_valid -> avalon_st_adapter_004:in_0_valid
	wire   [33:0] donesignal_s1_agent_rdata_fifo_out_data;                                     // doneSignal_s1_agent_rdata_fifo:out_data -> avalon_st_adapter_004:in_0_data
	wire          donesignal_s1_agent_rdata_fifo_out_ready;                                    // avalon_st_adapter_004:in_0_ready -> doneSignal_s1_agent_rdata_fifo:out_ready
	wire          avalon_st_adapter_004_out_0_valid;                                           // avalon_st_adapter_004:out_0_valid -> doneSignal_s1_agent:rdata_fifo_sink_valid
	wire   [33:0] avalon_st_adapter_004_out_0_data;                                            // avalon_st_adapter_004:out_0_data -> doneSignal_s1_agent:rdata_fifo_sink_data
	wire          avalon_st_adapter_004_out_0_ready;                                           // doneSignal_s1_agent:rdata_fifo_sink_ready -> avalon_st_adapter_004:out_0_ready
	wire    [0:0] avalon_st_adapter_004_out_0_error;                                           // avalon_st_adapter_004:out_0_error -> doneSignal_s1_agent:rdata_fifo_sink_error
	...
	altera_merlin_slave_translator #(
		...
		.AV_SETUP_WAIT_CYCLES           (0),
		.AV_DATA_HOLD_CYCLES            (0)
	) startsignal_s1_translator (
		.clk                    (sys_clk_sys_clk_clk),                              //                      clk.clk
		.reset                  (system_console_reset_reset_bridge_in_reset_reset), //                    reset.reset
		.uav_address            (startsignal_s1_agent_m0_address),                  // avalon_universal_slave_0.address
		.uav_burstcount         (startsignal_s1_agent_m0_burstcount),               //                         .burstcount
		.uav_read               (startsignal_s1_agent_m0_read),                     //                         .read
		.uav_write              (startsignal_s1_agent_m0_write),                    //                         .write
		.uav_waitrequest        (startsignal_s1_agent_m0_waitrequest),              //                         .waitrequest
		.uav_readdatavalid      (startsignal_s1_agent_m0_readdatavalid),            //                         .readdatavalid
		.uav_byteenable         (startsignal_s1_agent_m0_byteenable),               //                         .byteenable
		.uav_readdata           (startsignal_s1_agent_m0_readdata),                 //                         .readdata
		.uav_writedata          (startsignal_s1_agent_m0_writedata),                //                         .writedata
		.uav_lock               (startsignal_s1_agent_m0_lock),                     //                         .lock
		.uav_debugaccess        (startsignal_s1_agent_m0_debugaccess),              //                         .debugaccess
		.av_address             (StartSignal_s1_address),                           //      avalon_anti_slave_0.address
		.av_write               (StartSignal_s1_write),                             //                         .write
		.av_readdata            (StartSignal_s1_readdata),                          //                         .readdata
		.av_writedata           (StartSignal_s1_writedata),                         //                         .writedata
		.av_chipselect          (StartSignal_s1_chipselect),                        //                         .chipselect
		.av_read                (),                                                 //              (terminated)
		.av_begintransfer       (),                                                 //              (terminated)
		.av_beginbursttransfer  (),                                                 //              (terminated)
		.av_burstcount          (),                                                 //              (terminated)
	...
	altera_merlin_slave_translator #(
		...
		.AV_SETUP_WAIT_CYCLES           (0),
		.AV_DATA_HOLD_CYCLES            (0)
	) donesignal_s1_translator (
		.clk                    (sys_clk_sys_clk_clk),                              //                      clk.clk
		.reset                  (system_console_reset_reset_bridge_in_reset_reset), //                    reset.reset
		.uav_address            (donesignal_s1_agent_m0_address),                   // avalon_universal_slave_0.address
		.uav_burstcount         (donesignal_s1_agent_m0_burstcount),                //                         .burstcount
		.uav_read               (donesignal_s1_agent_m0_read),                      //                         .read
		.uav_write              (donesignal_s1_agent_m0_write),                     //                         .write
		.uav_waitrequest        (donesignal_s1_agent_m0_waitrequest),               //                         .waitrequest
		.uav_readdatavalid      (donesignal_s1_agent_m0_readdatavalid),             //                         .readdatavalid
		.uav_byteenable         (donesignal_s1_agent_m0_byteenable),                //                         .byteenable
		.uav_readdata           (donesignal_s1_agent_m0_readdata),                  //                         .readdata
		.uav_writedata          (donesignal_s1_agent_m0_writedata),                 //                         .writedata
		.uav_lock               (donesignal_s1_agent_m0_lock),                      //                         .lock
		.uav_debugaccess        (donesignal_s1_agent_m0_debugaccess),               //                         .debugaccess
		.av_address             (doneSignal_s1_address),                            //      avalon_anti_slave_0.address
		.av_write               (doneSignal_s1_write),                              //                         .write
		.av_readdata            (doneSignal_s1_readdata),                           //                         .readdata
		.av_writedata           (doneSignal_s1_writedata),                          //                         .writedata
		.av_chipselect          (doneSignal_s1_chipselect),                         //                         .chipselect
		.av_read                (),                                                 //              (terminated)
		.av_begintransfer       (),                                                 //              (terminated)
		.av_beginbursttransfer  (),                                                 //              (terminated)
		.av_burstcount          (),                                                 //              (terminated)
	...
	altera_merlin_slave_agent #(
		...
		.USE_WRITERESPONSE         (0),
		.ECC_ENABLE                (0)
	) startsignal_s1_agent (
		.clk                     (sys_clk_sys_clk_clk),                                //             clk.clk
		.reset                   (system_console_reset_reset_bridge_in_reset_reset),   //       clk_reset.reset
		.m0_address              (startsignal_s1_agent_m0_address),                    //              m0.address
		.m0_burstcount           (startsignal_s1_agent_m0_burstcount),                 //                .burstcount
		.m0_byteenable           (startsignal_s1_agent_m0_byteenable),                 //                .byteenable
		.m0_debugaccess          (startsignal_s1_agent_m0_debugaccess),                //                .debugaccess
		.m0_lock                 (startsignal_s1_agent_m0_lock),                       //                .lock
		.m0_readdata             (startsignal_s1_agent_m0_readdata),                   //                .readdata
		.m0_readdatavalid        (startsignal_s1_agent_m0_readdatavalid),              //                .readdatavalid
		.m0_read                 (startsignal_s1_agent_m0_read),                       //                .read
		.m0_waitrequest          (startsignal_s1_agent_m0_waitrequest),                //                .waitrequest
		.m0_writedata            (startsignal_s1_agent_m0_writedata),                  //                .writedata
		.m0_write                (startsignal_s1_agent_m0_write),                      //                .write
		.rp_endofpacket          (startsignal_s1_agent_rp_endofpacket),                //              rp.endofpacket
		.rp_ready                (startsignal_s1_agent_rp_ready),                      //                .ready
		.rp_valid                (startsignal_s1_agent_rp_valid),                      //                .valid
		.rp_data                 (startsignal_s1_agent_rp_data),                       //                .data
		.rp_startofpacket        (startsignal_s1_agent_rp_startofpacket),              //                .startofpacket
		.cp_ready                (startsignal_s1_burst_adapter_source0_ready),         //              cp.ready
		.cp_valid                (startsignal_s1_burst_adapter_source0_valid),         //                .valid
		.cp_data                 (startsignal_s1_burst_adapter_source0_data),          //                .data
		.cp_startofpacket        (startsignal_s1_burst_adapter_source0_startofpacket), //                .startofpacket
		.cp_endofpacket          (startsignal_s1_burst_adapter_source0_endofpacket),   //                .endofpacket
		.cp_channel              (startsignal_s1_burst_adapter_source0_channel),       //                .channel
		.rf_sink_ready           (startsignal_s1_agent_rsp_fifo_out_ready),            //         rf_sink.ready
		.rf_sink_valid           (startsignal_s1_agent_rsp_fifo_out_valid),            //                .valid
		.rf_sink_startofpacket   (startsignal_s1_agent_rsp_fifo_out_startofpacket),    //                .startofpacket
		.rf_sink_endofpacket     (startsignal_s1_agent_rsp_fifo_out_endofpacket),      //                .endofpacket
		.rf_sink_data            (startsignal_s1_agent_rsp_fifo_out_data),             //                .data
		.rf_source_ready         (startsignal_s1_agent_rf_source_ready),               //       rf_source.ready
		.rf_source_valid         (startsignal_s1_agent_rf_source_valid),               //                .valid
		.rf_source_startofpacket (startsignal_s1_agent_rf_source_startofpacket),       //                .startofpacket
		.rf_source_endofpacket   (startsignal_s1_agent_rf_source_endofpacket),         //                .endofpacket
		.rf_source_data          (startsignal_s1_agent_rf_source_data),                //                .data
		.rdata_fifo_sink_ready   (avalon_st_adapter_003_out_0_ready),                  // rdata_fifo_sink.ready
		.rdata_fifo_sink_valid   (avalon_st_adapter_003_out_0_valid),                  //                .valid
		.rdata_fifo_sink_data    (avalon_st_adapter_003_out_0_data),                   //                .data
		.rdata_fifo_sink_error   (avalon_st_adapter_003_out_0_error),                  //                .error
		.rdata_fifo_src_ready    (startsignal_s1_agent_rdata_fifo_src_ready),          //  rdata_fifo_src.ready
		.rdata_fifo_src_valid    (startsignal_s1_agent_rdata_fifo_src_valid),          //                .valid
		.rdata_fifo_src_data     (startsignal_s1_agent_rdata_fifo_src_data),           //                .data
		.m0_response             (2'b00),                                              //     (terminated)
		.m0_writeresponsevalid   (1'b0)                                                //     (terminated)
	);
	...
	altera_avalon_sc_fifo #(
		...
		.USE_ALMOST_FULL_IF  (0),
		.USE_ALMOST_EMPTY_IF (0)
	) startsignal_s1_agent_rsp_fifo (
		.clk               (sys_clk_sys_clk_clk),                              //       clk.clk
		.reset             (system_console_reset_reset_bridge_in_reset_reset), // clk_reset.reset
		.in_data           (startsignal_s1_agent_rf_source_data),              //        in.data
		.in_valid          (startsignal_s1_agent_rf_source_valid),             //          .valid
		.in_ready          (startsignal_s1_agent_rf_source_ready),             //          .ready
		.in_startofpacket  (startsignal_s1_agent_rf_source_startofpacket),     //          .startofpacket
		.in_endofpacket    (startsignal_s1_agent_rf_source_endofpacket),       //          .endofpacket
		.out_data          (startsignal_s1_agent_rsp_fifo_out_data),           //       out.data
		.out_valid         (startsignal_s1_agent_rsp_fifo_out_valid),          //          .valid
		.out_ready         (startsignal_s1_agent_rsp_fifo_out_ready),          //          .ready
		.out_startofpacket (startsignal_s1_agent_rsp_fifo_out_startofpacket),  //          .startofpacket
		.out_endofpacket   (startsignal_s1_agent_rsp_fifo_out_endofpacket),    //          .endofpacket
		.csr_address       (2'b00),                                            // (terminated)
		.csr_read          (1'b0),                                             // (terminated)
		.csr_write         (1'b0),                                             // (terminated)
		.csr_readdata      (),                                                 // (terminated)
	...
	altera_avalon_sc_fifo #(
		...
		.USE_ALMOST_FULL_IF  (0),
		.USE_ALMOST_EMPTY_IF (0)
	) startsignal_s1_agent_rdata_fifo (
		.clk               (sys_clk_sys_clk_clk),                              //       clk.clk
		.reset             (system_console_reset_reset_bridge_in_reset_reset), // clk_reset.reset
		.in_data           (startsignal_s1_agent_rdata_fifo_src_data),         //        in.data
		.in_valid          (startsignal_s1_agent_rdata_fifo_src_valid),        //          .valid
		.in_ready          (startsignal_s1_agent_rdata_fifo_src_ready),        //          .ready
		.out_data          (startsignal_s1_agent_rdata_fifo_out_data),         //       out.data
		.out_valid         (startsignal_s1_agent_rdata_fifo_out_valid),        //          .valid
		.out_ready         (startsignal_s1_agent_rdata_fifo_out_ready),        //          .ready
		.csr_address       (2'b00),                                            // (terminated)
		.csr_read          (1'b0),                                             // (terminated)
		.csr_write         (1'b0),                                             // (terminated)
		.csr_readdata      (),                                                 // (terminated)
	...
	altera_merlin_slave_agent #(
		...
		.clk                     (sys_clk_sys_clk_clk),                               //             clk.clk
		.reset                   (system_console_reset_reset_bridge_in_reset_reset),  //       clk_reset.reset
		.m0_address              (donesignal_s1_agent_m0_address),                    //              m0.address
		.m0_burstcount           (donesignal_s1_agent_m0_burstcount),                 //                .burstcount
		.m0_byteenable           (donesignal_s1_agent_m0_byteenable),                 //                .byteenable
		.m0_debugaccess          (donesignal_s1_agent_m0_debugaccess),                //                .debugaccess
		.m0_lock                 (donesignal_s1_agent_m0_lock),                       //                .lock
		.m0_readdata             (donesignal_s1_agent_m0_readdata),                   //                .readdata
		.m0_readdatavalid        (donesignal_s1_agent_m0_readdatavalid),              //                .readdatavalid
		.m0_read                 (donesignal_s1_agent_m0_read),                       //                .read
		.m0_waitrequest          (donesignal_s1_agent_m0_waitrequest),                //                .waitrequest
		.m0_writedata            (donesignal_s1_agent_m0_writedata),                  //                .writedata
		.m0_write                (donesignal_s1_agent_m0_write),                      //                .write
		.rp_endofpacket          (donesignal_s1_agent_rp_endofpacket),                //              rp.endofpacket
		.rp_ready                (donesignal_s1_agent_rp_ready),                      //                .ready
		.rp_valid                (donesignal_s1_agent_rp_valid),                      //                .valid
		.rp_data                 (donesignal_s1_agent_rp_data),                       //                .data
		.rp_startofpacket        (donesignal_s1_agent_rp_startofpacket),              //                .startofpacket
		.cp_ready                (donesignal_s1_burst_adapter_source0_ready),         //              cp.ready
		.cp_valid                (donesignal_s1_burst_adapter_source0_valid),         //                .valid
		.cp_data                 (donesignal_s1_burst_adapter_source0_data),          //                .data
		.cp_startofpacket        (donesignal_s1_burst_adapter_source0_startofpacket), //                .startofpacket
		.cp_endofpacket          (donesignal_s1_burst_adapter_source0_endofpacket),   //                .endofpacket
		.cp_channel              (donesignal_s1_burst_adapter_source0_channel),       //                .channel
		.rf_sink_ready           (donesignal_s1_agent_rsp_fifo_out_ready),            //         rf_sink.ready
		.rf_sink_valid           (donesignal_s1_agent_rsp_fifo_out_valid),            //                .valid
		.rf_sink_startofpacket   (donesignal_s1_agent_rsp_fifo_out_startofpacket),    //                .startofpacket
		.rf_sink_endofpacket     (donesignal_s1_agent_rsp_fifo_out_endofpacket),      //                .endofpacket
		.rf_sink_data            (donesignal_s1_agent_rsp_fifo_out_data),             //                .data
		.rf_source_ready         (donesignal_s1_agent_rf_source_ready),               //       rf_source.ready
		.rf_source_valid         (donesignal_s1_agent_rf_source_valid),               //                .valid
		.rf_source_startofpacket (donesignal_s1_agent_rf_source_startofpacket),       //                .startofpacket
		.rf_source_endofpacket   (donesignal_s1_agent_rf_source_endofpacket),         //                .endofpacket
		.rf_source_data          (donesignal_s1_agent_rf_source_data),                //                .data
		.rdata_fifo_sink_ready   (avalon_st_adapter_004_out_0_ready),                 // rdata_fifo_sink.ready
		.rdata_fifo_sink_valid   (avalon_st_adapter_004_out_0_valid),                 //                .valid
		.rdata_fifo_sink_data    (avalon_st_adapter_004_out_0_data),                  //                .data
		.rdata_fifo_sink_error   (avalon_st_adapter_004_out_0_error),                 //                .error
		.rdata_fifo_src_ready    (donesignal_s1_agent_rdata_fifo_src_ready),          //  rdata_fifo_src.ready
		.rdata_fifo_src_valid    (donesignal_s1_agent_rdata_fifo_src_valid),          //                .valid
		.rdata_fifo_src_data     (donesignal_s1_agent_rdata_fifo_src_data),           //                .data
		.m0_response             (2'b00),                                             //     (terminated)
		.m0_writeresponsevalid   (1'b0)                                               //     (terminated)
	);
	...
	altera_avalon_sc_fifo #(
		...
		.USE_ALMOST_FULL_IF  (0),
		.USE_ALMOST_EMPTY_IF (0)
	) donesignal_s1_agent_rsp_fifo (
		.clk               (sys_clk_sys_clk_clk),                              //       clk.clk
		.reset             (system_console_reset_reset_bridge_in_reset_reset), // clk_reset.reset
		.in_data           (donesignal_s1_agent_rf_source_data),               //        in.data
		.in_valid          (donesignal_s1_agent_rf_source_valid),              //          .valid
		.in_ready          (donesignal_s1_agent_rf_source_ready),              //          .ready
		.in_startofpacket  (donesignal_s1_agent_rf_source_startofpacket),      //          .startofpacket
		.in_endofpacket    (donesignal_s1_agent_rf_source_endofpacket),        //          .endofpacket
		.out_data          (donesignal_s1_agent_rsp_fifo_out_data),            //       out.data
		.out_valid         (donesignal_s1_agent_rsp_fifo_out_valid),           //          .valid
		.out_ready         (donesignal_s1_agent_rsp_fifo_out_ready),           //          .ready
		.out_startofpacket (donesignal_s1_agent_rsp_fifo_out_startofpacket),   //          .startofpacket
		.out_endofpacket   (donesignal_s1_agent_rsp_fifo_out_endofpacket),     //          .endofpacket
		.csr_address       (2'b00),                                            // (terminated)
		.csr_read          (1'b0),                                             // (terminated)
		.csr_write         (1'b0),                                             // (terminated)
		.csr_readdata      (),                                                 // (terminated)
	...
	altera_avalon_sc_fifo #(
		...
		.USE_ALMOST_FULL_IF  (0),
		.USE_ALMOST_EMPTY_IF (0)
	) donesignal_s1_agent_rdata_fifo (
		.clk               (sys_clk_sys_clk_clk),                              //       clk.clk
		.reset             (system_console_reset_reset_bridge_in_reset_reset), // clk_reset.reset
		.in_data           (donesignal_s1_agent_rdata_fifo_src_data),          //        in.data
		.in_valid          (donesignal_s1_agent_rdata_fifo_src_valid),         //          .valid
		.in_ready          (donesignal_s1_agent_rdata_fifo_src_ready),         //          .ready
		.out_data          (donesignal_s1_agent_rdata_fifo_out_data),          //       out.data
		.out_valid         (donesignal_s1_agent_rdata_fifo_out_valid),         //          .valid
		.out_ready         (donesignal_s1_agent_rdata_fifo_out_ready),         //          .ready
		.csr_address       (2'b00),                                            // (terminated)
		.csr_read          (1'b0),                                             // (terminated)
		.csr_write         (1'b0),                                             // (terminated)
		.csr_readdata      (),                                                 // (terminated)
	...
	mysystem_mm_interconnect_1_router_002 router_005 (
		.sink_ready         (startsignal_s1_agent_rp_ready),                    //      sink.ready
		.sink_valid         (startsignal_s1_agent_rp_valid),                    //          .valid
		.sink_data          (startsignal_s1_agent_rp_data),                     //          .data
		.sink_startofpacket (startsignal_s1_agent_rp_startofpacket),            //          .startofpacket
		.sink_endofpacket   (startsignal_s1_agent_rp_endofpacket),              //          .endofpacket
		.clk                (sys_clk_sys_clk_clk),                              //       clk.clk
		.reset              (system_console_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	mysystem_mm_interconnect_1_router_002 router_006 (
		.sink_ready         (donesignal_s1_agent_rp_ready),                     //      sink.ready
		.sink_valid         (donesignal_s1_agent_rp_valid),                     //          .valid
		.sink_data          (donesignal_s1_agent_rp_data),                      //          .data
		.sink_startofpacket (donesignal_s1_agent_rp_startofpacket),             //          .startofpacket
		.sink_endofpacket   (donesignal_s1_agent_rp_endofpacket),               //          .endofpacket
		.clk                (sys_clk_sys_clk_clk),                              //       clk.clk
		.reset              (system_console_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	altera_merlin_burst_adapter #(
		...
		.source0_valid         (startsignal_s1_burst_adapter_source0_valid),         //   source0.valid
		.source0_data          (startsignal_s1_burst_adapter_source0_data),          //          .data
		.source0_channel       (startsignal_s1_burst_adapter_source0_channel),       //          .channel
		.source0_startofpacket (startsignal_s1_burst_adapter_source0_startofpacket), //          .startofpacket
		.source0_endofpacket   (startsignal_s1_burst_adapter_source0_endofpacket),   //          .endofpacket
		.source0_ready         (startsignal_s1_burst_adapter_source0_ready)          //          .ready
	);
	...
	altera_merlin_burst_adapter #(
		...
		.source0_valid         (donesignal_s1_burst_adapter_source0_valid),         //   source0.valid
		.source0_data          (donesignal_s1_burst_adapter_source0_data),          //          .data
		.source0_channel       (donesignal_s1_burst_adapter_source0_channel),       //          .channel
		.source0_startofpacket (donesignal_s1_burst_adapter_source0_startofpacket), //          .startofpacket
		.source0_endofpacket   (donesignal_s1_burst_adapter_source0_endofpacket),   //          .endofpacket
		.source0_ready         (donesignal_s1_burst_adapter_source0_ready)          //          .ready
	);
	...
	mysystem_mm_interconnect_0_avalon_st_adapter_001 #(
		...
		.in_clk_0_clk   (sys_clk_sys_clk_clk),                              // in_clk_0.clk
		.in_rst_0_reset (system_console_reset_reset_bridge_in_reset_reset), // in_rst_0.reset
		.in_0_data      (startsignal_s1_agent_rdata_fifo_out_data),         //     in_0.data
		.in_0_valid     (startsignal_s1_agent_rdata_fifo_out_valid),        //         .valid
		.in_0_ready     (startsignal_s1_agent_rdata_fifo_out_ready),        //         .ready
	...
	mysystem_mm_interconnect_0_avalon_st_adapter_001 #(
		...
		.in_clk_0_clk   (sys_clk_sys_clk_clk),                              // in_clk_0.clk
		.in_rst_0_reset (system_console_reset_reset_bridge_in_reset_reset), // in_rst_0.reset
		.in_0_data      (donesignal_s1_agent_rdata_fifo_out_data),          //     in_0.data
		.in_0_valid     (donesignal_s1_agent_rdata_fifo_out_valid),         //         .valid
		.in_0_ready     (donesignal_s1_agent_rdata_fifo_out_ready),         //         .ready
