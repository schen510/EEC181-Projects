...
module mysystem_mm_interconnect_2 (
	...
	wire          donesignal_s1_agent_rp_valid;                                      // doneSignal_s1_agent:rp_valid -> router_007:sink_valid
	wire  [115:0] donesignal_s1_agent_rp_data;                                       // doneSignal_s1_agent:rp_data -> router_007:sink_data
	wire          donesignal_s1_agent_rp_ready;                                      // router_007:sink_ready -> doneSignal_s1_agent:rp_ready
	wire          donesignal_s1_agent_rp_startofpacket;                              // doneSignal_s1_agent:rp_startofpacket -> router_007:sink_startofpacket
	wire          donesignal_s1_agent_rp_endofpacket;                                // doneSignal_s1_agent:rp_endofpacket -> router_007:sink_endofpacket
	...
	wire          startsignal_s1_agent_rp_valid;                                     // startSignal_s1_agent:rp_valid -> router_008:sink_valid
	wire  [115:0] startsignal_s1_agent_rp_data;                                      // startSignal_s1_agent:rp_data -> router_008:sink_data
	wire          startsignal_s1_agent_rp_ready;                                     // router_008:sink_ready -> startSignal_s1_agent:rp_ready
	wire          startsignal_s1_agent_rp_startofpacket;                             // startSignal_s1_agent:rp_startofpacket -> router_008:sink_startofpacket
	wire          startsignal_s1_agent_rp_endofpacket;                               // startSignal_s1_agent:rp_endofpacket -> router_008:sink_endofpacket
	...
	wire          cmd_mux_005_src_valid;                                             // cmd_mux_005:src_valid -> doneSignal_s1_burst_adapter:sink0_valid
	wire  [115:0] cmd_mux_005_src_data;                                              // cmd_mux_005:src_data -> doneSignal_s1_burst_adapter:sink0_data
	wire          cmd_mux_005_src_ready;                                             // doneSignal_s1_burst_adapter:sink0_ready -> cmd_mux_005:src_ready
	wire    [6:0] cmd_mux_005_src_channel;                                           // cmd_mux_005:src_channel -> doneSignal_s1_burst_adapter:sink0_channel
	wire          cmd_mux_005_src_startofpacket;                                     // cmd_mux_005:src_startofpacket -> doneSignal_s1_burst_adapter:sink0_startofpacket
	wire          cmd_mux_005_src_endofpacket;                                       // cmd_mux_005:src_endofpacket -> doneSignal_s1_burst_adapter:sink0_endofpacket
	...
	wire    [6:0] donesignal_s1_burst_adapter_source0_channel;                       // doneSignal_s1_burst_adapter:source0_channel -> doneSignal_s1_agent:cp_channel
	...
	wire          cmd_mux_006_src_valid;                                             // cmd_mux_006:src_valid -> startSignal_s1_burst_adapter:sink0_valid
	wire  [115:0] cmd_mux_006_src_data;                                              // cmd_mux_006:src_data -> startSignal_s1_burst_adapter:sink0_data
	wire          cmd_mux_006_src_ready;                                             // startSignal_s1_burst_adapter:sink0_ready -> cmd_mux_006:src_ready
	wire    [6:0] cmd_mux_006_src_channel;                                           // cmd_mux_006:src_channel -> startSignal_s1_burst_adapter:sink0_channel
	wire          cmd_mux_006_src_startofpacket;                                     // cmd_mux_006:src_startofpacket -> startSignal_s1_burst_adapter:sink0_startofpacket
	wire          cmd_mux_006_src_endofpacket;                                       // cmd_mux_006:src_endofpacket -> startSignal_s1_burst_adapter:sink0_endofpacket
	...
	wire    [6:0] startsignal_s1_burst_adapter_source0_channel;                      // startSignal_s1_burst_adapter:source0_channel -> startSignal_s1_agent:cp_channel
	...
	wire          donesignal_s1_agent_rdata_fifo_out_valid;                          // doneSignal_s1_agent_rdata_fifo:out_valid -> avalon_st_adapter_005:in_0_valid
	wire   [33:0] donesignal_s1_agent_rdata_fifo_out_data;                           // doneSignal_s1_agent_rdata_fifo:out_data -> avalon_st_adapter_005:in_0_data
	wire          donesignal_s1_agent_rdata_fifo_out_ready;                          // avalon_st_adapter_005:in_0_ready -> doneSignal_s1_agent_rdata_fifo:out_ready
	wire          avalon_st_adapter_005_out_0_valid;                                 // avalon_st_adapter_005:out_0_valid -> doneSignal_s1_agent:rdata_fifo_sink_valid
	wire   [33:0] avalon_st_adapter_005_out_0_data;                                  // avalon_st_adapter_005:out_0_data -> doneSignal_s1_agent:rdata_fifo_sink_data
	wire          avalon_st_adapter_005_out_0_ready;                                 // doneSignal_s1_agent:rdata_fifo_sink_ready -> avalon_st_adapter_005:out_0_ready
	wire    [0:0] avalon_st_adapter_005_out_0_error;                                 // avalon_st_adapter_005:out_0_error -> doneSignal_s1_agent:rdata_fifo_sink_error
	wire          startsignal_s1_agent_rdata_fifo_out_valid;                         // startSignal_s1_agent_rdata_fifo:out_valid -> avalon_st_adapter_006:in_0_valid
	wire   [33:0] startsignal_s1_agent_rdata_fifo_out_data;                          // startSignal_s1_agent_rdata_fifo:out_data -> avalon_st_adapter_006:in_0_data
	wire          startsignal_s1_agent_rdata_fifo_out_ready;                         // avalon_st_adapter_006:in_0_ready -> startSignal_s1_agent_rdata_fifo:out_ready
	wire          avalon_st_adapter_006_out_0_valid;                                 // avalon_st_adapter_006:out_0_valid -> startSignal_s1_agent:rdata_fifo_sink_valid
	wire   [33:0] avalon_st_adapter_006_out_0_data;                                  // avalon_st_adapter_006:out_0_data -> startSignal_s1_agent:rdata_fifo_sink_data
	wire          avalon_st_adapter_006_out_0_ready;                                 // startSignal_s1_agent:rdata_fifo_sink_ready -> avalon_st_adapter_006:out_0_ready
	wire    [0:0] avalon_st_adapter_006_out_0_error;                                 // avalon_st_adapter_006:out_0_error -> startSignal_s1_agent:rdata_fifo_sink_error
	...
	mysystem_mm_interconnect_2_router_002 router_007 (
	...
	mysystem_mm_interconnect_2_router_002 router_008 (
	...
	mysystem_mm_interconnect_2_cmd_mux cmd_mux_005 (
		.clk                 (sys_clk_sys_clk_clk),                           //       clk.clk
		.reset               (jtag_uart_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	mysystem_mm_interconnect_2_cmd_mux cmd_mux_006 (
		.clk                 (sys_clk_sys_clk_clk),                           //       clk.clk
		.reset               (jtag_uart_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	mysystem_mm_interconnect_2_rsp_demux rsp_demux_005 (
		.clk                (sys_clk_sys_clk_clk),                           //       clk.clk
		.reset              (jtag_uart_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	mysystem_mm_interconnect_2_rsp_demux rsp_demux_006 (
		.clk                (sys_clk_sys_clk_clk),                           //       clk.clk
		.reset              (jtag_uart_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
